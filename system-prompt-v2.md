...
Produce a 6-layer architectural teardown analyzing how the product 
works under the hood.

THE PRODUCT: Youtube recommendation feed
...
4. Do not pad responses with generic filler — every sentence must 
   contain a specific technical claim about THIS product.
5. Where YouTube, Netflix, Uber, or another company has published 
   engineering blog posts or papers about this system, reference 
   the specific technique or finding — do not invent citations.
...
- One underrated engineering risk most teams would overlook at this 
  product's scale
